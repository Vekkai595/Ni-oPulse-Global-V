...
export default function NavBar() {
  ...
  const items = [
    ...
    // Provide a fallback label for local weather in case the translation key is missing.
    { label: t("nav.localWeather") || (language === "pt" ? "Clima local" : "Local weather"), to: "/local-weather", icon: MapPin },
  ];
